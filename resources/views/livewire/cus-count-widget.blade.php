<x-filament-widgets::widget @class('grid grid-cols-12 gap-4 w-full')>
    ...
    <x-filament::section @class('col-span-4 col-start-7')>
        ...
        <x-filament::section @class('col-span-2 col-start-1')>
            <div class="text-center">
    ...
    <x-filament::section @class('col-span-2 col-start-3')>
        <div class="text-center">
    ...
    <x-filament::section @class('col-span-2 col-start-5')>
        <div class="text-center">
    ...
    <x-filament::section @class('col-span-2 col-start-7')>
        <div class="text-center">
    ...
    <x-filament::section @class('col-span-2 col-start-9')>
        <div class="text-center">
    ...
    <x-filament::section @class('col-span-2 col-start-11')>
        <div class="text-center">
